...
json_file = open(r'F:\Vikas\Drowsiness_Detection\my_project\model1.json', 'r')
...
try:
    face_cascade = cv2.CascadeClassifier(r"F:\Vikas\Drowsiness_Detection\my_project\haarcascade_frontalface_default2.xml")
except Exception:
...
def main():
    ...
    activiteis = ["Home", "Drowsiness Detection", "About"]
    choice = st.sidebar.selectbox("Select Activity", activiteis)
    st.sidebar.markdown(
        """ Developed by Vikas Sharma    
    ...
    if choice == "Home":
        html_temp_home1 = """<div style="background-color:#6D7B8D;padding:10px">
                                            ...
                                            Drowsiness Detection application using OpenCV, Custom CNN model and Streamlit.</h4>
                                            </div>
                                            </br>"""
        ...
        st.write("Click on start to use webcam and detect your Drowsiness Detection")
        ...
        html_temp_about1= """<div style="background-color:#6D7B8D;padding:10px">
                                    <h4 style="color:white;text-align:center;">
                                    Real time Drowsiness Detection application using OpenCV, Custom Trained CNN model and Streamlit.</h4>
                                    </div>
                                    </br>"""
